...
void Game::OnKeyboardInput(const GameTimer& gt)
{
	...
	{
		playerAircraft->move(forwardDir.x / 100.f, forwardDir.y / 100.f, forwardDir.z / 100.f);
	}
	...
	// Adjust yaw with A and D keys
	if (GetAsyncKeyState('A') & 0x8000)
	{
		playerAircraft->adjustYaw(-turnSpeed * dt);
	}
	...
	// Adjust pitch with Q and E keys
	if (GetAsyncKeyState('Q') & 0x8000)
	{
		playerAircraft->adjustPitch(turnSpeed * dt);
	}
